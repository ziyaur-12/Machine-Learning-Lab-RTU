...
### Output 1 - Original Dataset Scatter Plot

This graph shows the original data points used for training the Locally Weighted Regression model.

<p align="center">
  <img src="output_1.png" alt="Output 1 - Scatter Plot" width="700">
</p>

---

### Output 2 - Locally Weighted Regression Curve

This graph illustrates the smooth regression curve generated by the Locally Weighted Regression (LWR) algorithm after fitting the data points.

<p align="center">
  <img src="output_2.png" alt="Output 2 - Regression Curve" width="700">
</p>
